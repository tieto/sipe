...
Also media transport over TCP will not work, proof of concept implementation for
libnice exists, it is now in state of code cleanup and integration into upstream
libraries. Contact jakub (dot) adam (at) ktknet (dot) cz for details
