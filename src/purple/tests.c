...
//01000000E615438A917661BE64000000
	...
	guint8 *nonce2;
	int ntlmssp_nt_resp2_len = (16 + (32+target_info2_len));
	guchar nt_challenge_response_v2_2 [ntlmssp_nt_resp2_len];
...
////// UUID tests ///////
	...
	calcUUID = generateUUIDfromEPID(testEpid);
